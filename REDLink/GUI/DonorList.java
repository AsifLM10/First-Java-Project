...
public class DonorList extends JFrame implements ActionListener{
		...
		public DonorList(Account acc)
		{
			
		super("DonorList frame");
		...
		intro=new JLabel("Donor List");//"Donor List"
		...
		String [][] data={                        //for table
			{"abdur","Dhaka","01834288180"},
			{"rauf","Newmarket","01834288180"},
			{"asif","Asad Gate","01761525353"},
		    {acc.getusername(),acc.getuserarea(),acc.getuserphn()}
		};
